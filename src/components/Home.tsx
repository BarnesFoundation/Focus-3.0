...
export const Home: React.FC = () => {
  const { getLocalStorage, resetLocalStorage } = useLocalStorage();
  const { getTranslation } = useContext(TranslationContext);
  const history = useHistory();
  const [snapAttempts, setSnapAttempts] = useState(
    getLocalStorage(constants.SNAP_ATTEMPTS) || 0
  );
      ...
      {userAtBarnes == null && (
        <div className="landing-screen">
          ...
          <div className="home-action">
            ...
            <button className="action-btn" onClick={() => setUserAtBarnes(false)}>
              <span className="action-text h2">
                <Textfit mode="single" max={25}>
        ...
        <div>
          <div className="app-usage-alert h2">
            <div className="app-usage-msg">
              ...
              <span>
                {" "}
                {getTranslation("Visit_soon", "text_2")}
              </span>
            </div>
      ...
      >
        ...
        {this.state.userAtBarnes == null && (
          <div className="landing-screen">
            ...
            <div className="user-loc-prompt">
              {this.props.getTranslation("Welcome_screen", "text_1")}{" "}
              <br aria-hidden={true} />
